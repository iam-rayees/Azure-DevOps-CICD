...
NEW_Sonar_Token: sqp_889eefc9c8dc883e562fc

# Execute it in EC2 machine.
mvn clean verify sonar:sonar \
  -Dsonar.projectKey=Prod_ADO \
  -Dsonar.host.url=http://sonarqube.cloudrayeez.xyz:9000 \
  -Dsonar.login=sqp_889eefc9c8dc883e562fc54a1fda681ac26695b8
